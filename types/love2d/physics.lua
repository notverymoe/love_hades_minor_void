...
---
---@param dt number # How long the force applies. Usually the time step or dt.
---@return number f # The current motor force, in Nm.
function RevoluteJoint:getMotorTorque(dt) end
...
function WheelJoint:getMotorTorque(dt) end
