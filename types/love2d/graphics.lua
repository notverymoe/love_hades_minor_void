...
---@param kind love.MeshDrawMode
---@param vertexCount integer
---@param instanceCount integer?
---@overload fun(index: love.Buffer, indexCount: integer, instanceCount: integer?, indexStart: integer?)
function love.graphics.drawFromShader(kind, vertexCount, instanceCount) end

---@class love.Buffer: love.Object
local Buffer = {}

---@alias love.BufferFormat {name: string?, format: love.VertexDataType, arraylength: integer?, location: integer?, offset: integer?, size: integer?}

---@class love.BufferSettings
---@field debugname string?
---@field shaderstorage boolean?
---@field index boolean?
---@field vertex boolean?
---@field texel boolean?

---@param format love.BufferFormat[]
---@param entries table
---@param settings love.BufferSettings
---@return love.Buffer
---@overload fun(format: love.BufferFormat, entryCount: number, settings: love.BufferSettings): love.Buffer
function love.graphics.newBuffer(format, entries, settings) end

---@param data table
---@param srcIndex integer?
---@param dstIndex integer?
---@param count integer?
function Buffer:setArrayData(data, srcIndex, dstIndex, count) end

---@param offset integer?
---@param size integer?
function Buffer:clear(offset, size) end
...
---@return integer
function Buffer:setSize() end

---@return love.BufferFormat[]
function Buffer:getFormat() end

---@return boolean
function Buffer:isBufferType() end

---@return boolean
function Buffer:getDebugName() end

---@alias love.StencilMode
--- | "off"
--- | "draw"
--- | "test"
--- | "custom"

---@param mode love.StencilMode
---@param value integer
function love.graphics.setStencilMode(mode, value) end

---@alias love.BlendFactor
--- | "zero"
--- | "one"
--- | "srccolor"
--- | "oneminussrccolor"
...
---
---@overload fun( operationRGB: love.BlendOperation, operationA: love.BlendOperation, srcFactorRGB: love.BlendFactor, srcFactorA: love.BlendFactor, dstFactorRGB: love.BlendFactor, dstFactorA: love.BlendFactor )
---@param operation love.BlendOperation
---@param srcFactor love.BlendFactor
---@param dstFactor love.BlendFactor
function love.graphics.setBlendState(operation, srcFactor, dstFactor) end

---
---Sets the projection matrix to a custom one.
---
---Can be set using a transform, or a list of values.
---In the case of a list of values, the MatrixLayout can be specified first or a default Row Major layout will be assumed.
---
---[Open in Browser](https://love2d.org/wiki/love.graphics.setProjection)
---
---@overload fun(layout: love.MatrixLayout, c11: number, c12: number, c13: number, c14: number, c21: number, c22: number, c23: number, c24: number, c31: number, c32: number, c33: number, c34: number, c41: number, c42: number, c43: number, c44: number)
---@overload fun(r1c1: number, r1c2: number, r1c3: number, r1c4: number, r2c1: number, r2c2: number, r2c3: number, r2c4: number, r3c1: number, r3c2: number, r3c3: number, r3c4: number, r4c1: number, r4c2: number, r4c3: number, r4c4: number)
---@param transform love.Transform
function love.graphics.setProjection(transform) end

---
---Resets the projection matrix to the default Love2D projection matrix.
---
---[Open in Browser](https://love2d.org/wiki/love.graphics.resetProjection)
---
function love.graphics.resetProjection() end
...
---
---@overload fun(x: number, y: number, angle?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number)
...
---
---In versions prior to 12.0, the scissor area used to bound the clear.
---
...
---@alias Love.CanvasSettings {type?: love.TextureType, format?: love.PixelFormat, readable?: boolean, msaa?: number, dpiscale?: number, mipmaps?: love.MipmapMode}
...
---@overload fun(width: number, height: number, settings: Love.CanvasSettings):love.Canvas
---@overload fun(width: number, height: number, layers: number, settings: Love.CanvasSettings):love.Canvas
...
--TODO merge with BufferFormat?
---@alias love.VertexFormat {name: string, format: love.VertexDataType, location: integer}[]
...
---@overload fun(vertexformat: love.BufferFormat, vertices: table, mode: love.MeshDrawMode, usage?: love.SpriteBatchUsage):love.Mesh
---@overload fun(vertexformat: love.BufferFormat, vertexcount: number, mode: love.MeshDrawMode, usage?: love.SpriteBatchUsage):love.Mesh
...
---@param mode love.MeshDrawMode # How the vertices are used when drawing.
...
---
---@overload fun(font: love.Font, coloredTextBatch: table):love.TextBatch
...
function love.graphics.newTextBatch(font, textstring) end
...
---
---@overload fun(coloredTextBatch: table, x?: number, y?: number, angle?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number)
---@overload fun(TextBatch: string, transform: love.Transform)
---@overload fun(coloredTextBatch: table, transform: love.Transform)
---@overload fun(TextBatch: string, font: love.Font, transform: love.Transform)
---@overload fun(coloredTextBatch: table, font: love.Font, transform: love.Transform)
...
---
---@overload fun(TextBatch: string, font: love.Font, x: number, y: number, limit: number, align?: love.AlignMode, r?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number)
---@overload fun(TextBatch: string, transform: love.Transform, limit: number, align?: love.AlignMode)
---@overload fun(TextBatch: string, font: love.Font, transform: love.Transform, limit: number, align?: love.AlignMode)
---@overload fun(coloredTextBatch: table, x: number, y: number, limit: number, align: love.AlignMode, angle?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number)
---@overload fun(coloredTextBatch: table, font: love.Font, x: number, y: number, limit: number, align?: love.AlignMode, angle?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number)
---@overload fun(coloredTextBatch: table, transform: love.Transform, limit: number, align?: love.AlignMode)
---@overload fun(coloredTextBatch: table, font: love.Font, transform: love.Transform, limit: number, align?: love.AlignMode)
...
---[Open in Browser](https://love2d.org/wiki/love.graphics)
---
---@class love.TextBatch: love.Drawable, love.Object
local TextBatch = {}
...
---
---@overload fun(self: love.TextBatch, coloredTextBatch: table, x?: number, y?: number, angle?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number):number
...
---@return number index # An index number that can be used with TextBatch:getWidth or TextBatch:getHeight.
function TextBatch:add(textstring, x, y, angle, sx, sy, ox, oy, kx, ky) end
...
---
---@overload fun(self: love.TextBatch, coloredTextBatch: table, wraplimit: number, align: love.AlignMode, x: number, y: number, angle?: number, sx?: number, sy?: number, ox?: number, oy?: number, kx?: number, ky?: number):number
---@param textstring string # The text to add to the object.
...
---@return number index # An index number that can be used with TextBatch:getWidth or TextBatch:getHeight.
function TextBatch:addf(textstring, wraplimit, align, x, y, angle, sx, sy, ox, oy, kx, ky) end
...
---
---@overload fun(self: love.TextBatch, index: number):number, number
---@return number width # The width of the text. If multiple sub-strings have been added with TextBatch:add, the width of the last sub-string is returned.
---@return number height # The height of the text. If multiple sub-strings have been added with TextBatch:add, the height of the last sub-string is returned.
function TextBatch:getDimensions() end
...
function TextBatch:getFont() end
...
---
---@overload fun(self: love.TextBatch, index: number):number
---@return number height # The height of the text. If multiple sub-strings have been added with TextBatch:add, the height of the last sub-string is returned.
function TextBatch:getHeight() end
...
---@overload fun(self: love.TextBatch, index: number):number
---@return number width # The width of the text. If multiple sub-strings have been added with TextBatch:add, the width of the last sub-string is returned.
function TextBatch:getWidth() end
...
---
---@overload fun(self: love.TextBatch, coloredTextBatch: table)
---@param textstring string # The new string of text to use.
function TextBatch:set(textstring) end
...
function TextBatch:setFont(font) end
...
---
---@overload fun(self: love.TextBatch, coloredTextBatch: table, wraplimit: number, align: love.AlignMode)
---@param textstring string # The new string of text to use.
---@param wraplimit number # The maximum width in pixels of the text before it gets automatically wrapped to a new line.
---@param align love.AlignMode # The alignment of the text.
function TextBatch:setf(textstring, wraplimit, align) end
